...
\author{Romeu Fernandes}

\titleA{Computational Design of Single-Stranded}
\titleB{DNA Probes for Graphene Field-Effect}
\titleC{Transistor Biosensors}

\masters{Master’s Dissertation in Bioinformatics}
%\area{Area of specialization}
\supervisor{[Supervisor — to complete]}
%\cosupervisor{[Co-Supervisor — if applicable]}
...
% Glossary (none defined — only acronyms are used)
