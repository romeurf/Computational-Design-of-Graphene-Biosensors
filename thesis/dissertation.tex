...
\author{Romeu Alexandre Ribeiro Fernandes}

\titleA{Computational Discovery of DNA}
\titleB{Aptamer-Graphene Sensors}
\titleC{}

\masters{Master’s Dissertation in Bioinformatics}
%\area{Area of specialization}
\supervisor{Dr. João Carneiro}
\cosupervisor{Dr. Pedro Soares}
